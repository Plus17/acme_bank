defmodule AcmeBankWeb.UserAuthTest do
  use AcmeBankWeb.ConnCase, async: true

  alias AcmeBank.Contexts.Accounts
  alias AcmeBankWeb.UserAuth

  @remember_me_cookie "_acme_bank_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AcmeBankWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      AcmeBankWeb.Endpoint.subscribe(live_socket_id)
