defmodule AcmeBankWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AcmeBankWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AcmeBankWeb.Gettext, "errors", msg, opts)
    end
  end
