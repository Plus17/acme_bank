defmodule Mix.Tasks.Gen.Manager do
  ...
  def build(args, help \\ __MODULE__) do
    ...
    basedir = Phoenix.Naming.underscore(schema_name)
    test_factories_dir = Mix.Phoenix.context_app_path(ctx_app, "test/support/factories")
